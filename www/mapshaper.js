...
// FrameCounter will prevent Node script from exiting
if (!Env.inNode) {
  FrameCounter.start();
}
...
Utils.inherit(TweenTimer, EventDispatcher);
...
Utils.inherit(NumberTween, TweenTimer);
