...
// Input format: 
// {
//    xx: [Array],      // All x-coords in the dataset (coords of all shapes are concatenated)
//    yy: [Array],      // All y-coords
...
// Output format:
// {
//    arcs: [Array],   // Arcs are arrays; arc[0] is an array of x-coords, arc[1] is an array of y-coords
//    shapes: [Array]  // Shapes are arrays of parts; Parts are arrays of arc-ids;
// }                   //   negative arc ids indicate reverse direction (see TopoJSON spec)
//
