...
See the [`-simplify` reference](/docs/reference.html#-simplify) for the full set of options.
...
The [`-clean`](/docs/reference.html#-clean) command will also remove intersections:
