...
describe('Issue #340 (-join unmatched unjoined should not change target layers)', function () {
  ...
  it('unjoined unmatched not added to default target', function(done) {
    api.applyCommands('-i test/data/geojson/three_points.geojson -join test/data/geojson/three_points.geojson unjoined unmatched keys=name,name_alt -o', function(err, output) {
  ...
  it('... but are generated', function(done) {
    api.applyCommands('-i test/data/geojson/three_points.geojson -join test/data/geojson/three_points.geojson unjoined unmatched keys=name,name_alt -o target=*', function(err, output) {
