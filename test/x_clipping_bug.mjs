  ...
  describe('mapshaper-clip-erase.js', function () {
    ...
    describe('Issue: bbox clipping can fail along almost-parallel segments', function () {
      ...
      it('test 2', function(done) {
        ...
        api.applyCommands('-i input.json -clip bbox=-1,0,0,1 -debug -o gj2008 output.json', {'input.json': polygon}, function(err, output) {
          var geojson = JSON.parse(output['output.json']);
